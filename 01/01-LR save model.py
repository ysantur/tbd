...
X_test = np.array(Testing_Dataset.iloc[:, 0]).reshape(-1,1)
y_test = np.array(Testing_Dataset.iloc[:, 1]).reshape(-1,1)
...
plt.scatter(X_train, y_train, color = 'red', marker = 'o', s = 35, alpha = 0.5,
          label = 'Test data')
