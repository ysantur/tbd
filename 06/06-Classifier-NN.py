...
l1=classifier.add(Dense(units = 100, kernel_initializer = 'uniform', activation = 'relu', input_dim = len(X.columns), name="layer1"))
classifier.add(Dropout(0.25))

classifier.add(Dense(units = 50, kernel_initializer = 'uniform', activation = 'relu', name="layer2"))
classifier.add(Dropout(0.25))

classifier.add(Dense(units = 20, kernel_initializer = 'uniform', activation = 'relu', name="layer3"))
classifier.add(Dropout(0.25))
